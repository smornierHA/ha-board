...
| P02 | P1 | Dépôt public HA-BOARD expurgé accessible, import sur branche/PR | Accès et main README initial vérifiés ; import complet sur branche/PR à faire |
| P03 | P1 | Besoin/architecture/fidélité/compatibilité/recette/runbook | Préparés, à versionner |
| P04 | P1 | Contrats de régression sur exemples fictifs | 19 exécutés, 12 échouent ; aucune correction appliquée |
...
| P08 | P1 | Corriger cycle async/filtres/reconfiguration/DOM après import GitHub | À faire sur branche dédiée, tests stricts verts |
| P09 | P1 | Dernière position connue/indisponibilité/précision | Contrat établi, implémentation à faire |
...
Étape immédiate du fil de réalisation : P02, importer les arbres préparés et expurgés sur branches/PR depuis les SHA main relus. Il n'y a plus de dépôt à créer. P14 ne réintroduit pas le coffre NAS comme préalable à cet import ; P06 reste une sauvegarde HA exploitable distincte avant toute mise à jour Core. RC.4 est documentaire uniquement, sources applicatives inchangées.
