...
| Tests locaux | Base RC.2 : 28/28 ; candidat #8 : 37/37 cartes + 3/3 adaptateur dans Node | N'atteste pas les Web Components réels ni le rendu ; recette HA nécessaire |
