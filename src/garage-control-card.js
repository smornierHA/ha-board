...
class GarageControlCard extends LitElement {
  ...
  setConfig(config) {
    ...
    this._config = {
      ...
      garage_service: undefined,
      garage_open_service: undefined,
      garage_close_service: undefined,
      garage_stop_service: undefined,
      ...
      live_detection_badge_duration_ms: 12000,
      show_debug: false,
      ...
      event_message_duration_ms: 12000,
  ...
  _scheduleConfirmationTimeout(actionToken) {
  ...
  async _runGarageAction() {
    ...
    try {
      ...
      this._releaseBusyAfter(Number(this._config.action_lock_ms || 2000));

      if (plan.expectedState) {
        this._scheduleConfirmationTimeout(actionToken);
