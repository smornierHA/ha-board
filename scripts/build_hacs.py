...
banner = "/* HA-BOARD 0.1.0-rc.1 | History 1.4.1 | Rich 3.4.4 */\n"
...
manifest = {"package_version":"0.1.0-rc.1","entrypoint":"dist/ha-board.js","sha256":hashlib.sha256(bundle.encode()).hexdigest(),"components":{"person-history-map-card-v14":"1.4.1","person-rich-card-v34":"3.4.4"}}
