...
def main():
    ...
    if existing:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for name in [item['file'] for item in artifacts] + ['manifest.json']:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        run('gh', 'release', 'create', tag, *[str(Path('dist', item['file'])) for item in artifacts], 'dist/manifest.json', str(proof),
